...
import com.miaw.pro.tunnel.aidl.IUltraSSHServiceInternal;
...
import com.miaw.pro.tunnel.tunnel.TunnelManagerThread;
...
import com.miaw.pro.tunnel.tunnel.DNSTunnelThread;
...
implements SkStatus.StateListener
{
	...
	public static final String START_SERVICE = "com.mod.slowdns:startTunnel";
	...
	private void showNotification(final String msg, final String channel,
		...
		if(tunnelType==Settings.bTUNNEL_TYPE_SSH_DIRECT){
			type = "Secure Shell (DIRECT) | VPN Premium";
		}else if(tunnelType==Settings.bTUNNEL_TYPE_SSH_PROXY){
			type = "Gunakan VPN dgn sebaiknya | Miaw VPN";
		}else if(tunnelType==Settings.bTUNNEL_TYPE_SSH_SSL){
			type = "Secure Shell (SSH + SSL) | VPN Premium";
		}else if(tunnelType==Settings.bTUNNEL_TYPE_SSL_PAYLOAD){
			type = "Secure Shell (SSL + PAYLOAD) | VPN Premium";
		}else if(tunnelType==Settings.bTUNNEL_TYPE_SLOWDNS){
			type = "Secure Shell (SlowDNS) | VPN Premium";
		}else{
