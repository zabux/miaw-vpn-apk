...
import com.miaw.pro.tunnel.util.Cripto;
import com.miaw.pro.tunnel.util.FileUtils;
import com.miaw.pro.tunnel.util.securepreferences.crypto.Cryptor;
import com.miaw.pro.tunnel.util.securepreferences.model.SecurityConfig;
...
public class ConfigParser
{
	...
	public static final String FILE_EXTENSAO = "skarti";
	private static final String KEY_PASSWORD = "JaInjector~•`...€£|";
	...
	public static boolean convertInputAndSave(InputStream input, Context mContext)
		...
		try {
			...
			try {
				...
				boolean isUdpForward = _isUdpForward != null && _isUdpForward.equals("1") ? false : true;
	...
	*/
	...
	static {
		mCrypto = Cryptor.initWithSecurityConfig(
			new SecurityConfig.Builder("'@$))[]{}¥~`|`™").build());
	}
